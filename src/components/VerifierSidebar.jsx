...
const Sidebar = () => {
  ...
  return (
    <SidebarContainer>
      ...
      <SidebarLink to="/VerifierHome">
        <IconLeft><FaHome />HomePage</IconLeft>
      </SidebarLink>
      

      <SidebarLink as="div" onClick={toggleSubmenu}>
              <IconLeft><FaClipboardCheck />Applicant List</IconLeft>
              <FaChevronDown />
            </SidebarLink>
            {showSubmenu && (
              <>
                <SubmenuLink to="/Pending">Pending</SubmenuLink>
                <SubmenuLink to="/Accepted">Accepted</SubmenuLink>
                <SubmenuLink to="/Rejected">Rejected</SubmenuLink>
              </>
            )}
    </SidebarContainer>
  );
